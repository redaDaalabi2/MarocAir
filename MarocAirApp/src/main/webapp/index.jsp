...
<section class="text-gray-600 body-font">
    <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
        <form action="ClientConnectionServlet" method="post" class="lg:w-1/2 md:w-1/2 bg-gray-100 rounded-lg p-8 flex justify-center flex-col md:mx-auto w-full mt-10 md:mt-0">
